function[ctr_bd,ctr_ind,xi,xb,ev_points,xe,ye]=generacion_puntos2(N,neval,ind)
...
if ind==2
   ctr_bd=[[-0.1*ones(1,nv);v],[1.1*ones(1,nv);v],[v(2:end-1);-0.1*ones(1,nv-2)],[v(2:end-1);1.1*ones(1,nv-2)]];   
else
    ctr_bd=xb;
end
v(1)=[];
