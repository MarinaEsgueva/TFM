%Ejemplo para la segunda EDP con el cambio de variable para hacerla
%homogenea. 
clear all
format short e
...
dyrbf='dyimq'
simul_u='u2'; %Función simulador.
simul_frontera='u2_cond_frontera' %Simulador de las codiciones de forntera
u_part='u2_part2';% Solución particular de la EDP.
epsilon=2.5; %Parámetro de forma de las RBF. 
...
%Generar puntos de colocación y centros de la forntera fuera del dominio. 
cont1=1;
cont2=1;
cont3=1;
for k=1:N
...
for i=1:nb1
f(ni+i,1)=0; %En este caso es cero. En otro caso: u_y(x,y)-u_part_y(x,y).
end
for i=1:nb2
f(ni+nb1+i,1)=feval(simul_frontera,xb2(1,i),xb2(2,i))-feval(u_part,xb2(1,i),xb2(2,i));
end
...
for i=1:neval^2
    ...
    aprox(i,1)=rbf_eval*coef+feval(u_part,ev_points(1,i),ev_points(2,i)); %Calculamos la aproximación con RBF en cada punto
