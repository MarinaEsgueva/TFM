...
simul_lu='Lu3'%Simulador del operador de laplace de la función.
simul_lupart='Lu3_part'; %Operador de laplace de la función simulador de la función con el cambio de variable correspondiente
simul_part='u3_part'; %Simulador de la solución particular.
epsilon=2.1; %Parámetro de forma de las RBF. 
ind=2;
